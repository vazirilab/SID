function filtered=cellfilter(stack,sigma,znonuniformity)
...
if size(filter1o,1)>size(filter2o,1)
    fitler2o=padarray(filter2o,[size(filter1o,1)-size(filter2o,1),0,0]/2);
...
if size(filter1o,2)>size(filter2o,2)
    fitler2o=padarray(filter2o,[0, size(filter1o,2)-size(filter2o,2),0]/2);
...
if size(filter1o,3)>size(filter2o,3)
    fitler2o=padarray(filter2o,[0, 0, size(filter1o,3)-size(filter2o,3)]/2);
